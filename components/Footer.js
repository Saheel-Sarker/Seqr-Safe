    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            <Link href="/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <span className={`self-center text-2xl whitespace-nowrap dark:text-white ${font.className}`}>Keep-Safe</span>
            </Link>
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="/" className="hover:underline">Keep-Safe™</Link>. All Rights Reserved.</span>
    </div>
</footer>
