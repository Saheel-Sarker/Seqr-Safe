...
export default function TermsConditions() {
  ...
  return (
    ...
    <div className="bg-slate-800 rounded-lg p-8 max-w-7xl w-full">
      ...
      <h1 className='text-lg font-medium text-white'>These terms of Service govern your use of the Keepr website. By accessing or using the Website, you agree to be bound by these Terms. If you do not agree with any part of these Terms, you may not access or use the Website.</h1>
